...
public class Prjava43vaquero19 extends Frame 
   ...
   public Prjava43vaquero19 () { 
      ...
      setTitle("nova finestra prjava43vaquero19");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43vaquero19();  // Let the construct do the job 
   } 
